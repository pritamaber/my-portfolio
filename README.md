...
As this is build using vite + react , we use client side rendering and for blogs it uses markdown files .

Feel free to drop and email at - pritam.aber@gmail.com for any suggestions or just a chat .
