const projects = [
  {
    title: "Taskify",
    description:
      "A fullstack task manager built with React, Tailwind, Express, and MongoDB. Features add/edit/delete, completion tracking, and clean toastified UI.",
    liveLink: "https://taskify.impritam.com",
    githubLink: "https://github.com/pritamaber/taskify", // adjust if needed
    badge: "Fullstack",
